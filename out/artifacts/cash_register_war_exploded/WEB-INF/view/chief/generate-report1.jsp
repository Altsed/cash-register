...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %><pd4tl:transform
        screenWidth="1024"
        pageFormat="A4"
...
<div class="container h-100">
    <div class="d-flex h-100">
        <div class="align-self-start mr-auto">
            ...
            <form name="generateReport" method="POST" action="update-receipt">
...
<pd4tl:savefile
        dir="D:/temp/"
        redirect="/send_pdf_by_email.jsp"
        debug="false"/>
